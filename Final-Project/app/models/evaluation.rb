class Evaluation < ApplicationRecord
  ...
  validate :user_cannot_evaluate_multiple_times

  private

  def user_cannot_evaluate_multiple_times
    if Evaluation.exists?(user_id: user.id, presentation_id: presentation_id)
